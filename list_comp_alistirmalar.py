...
df.columns
df.info()
# object olmayanların başına NUM_ getridik olanları ise sadece büyültmüş olduk.
df.columns = ["NUM_" + col.upper() if df[col].dtype != "object" else col.upper() for col in df.columns]
